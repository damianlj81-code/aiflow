          ...
          <div className="flex items-center gap-2">
            <div className="hidden sm:flex items-center gap-1 p-1 rounded-xl"
              ...
              {[
                ...
                { label: 'Aplikacje',    href: '/?view=aplikacje',       active: false },
                { label: 'Aplikacje 2',  href: '/text.html',             active: true  },
                { label: 'Dodatki',      href: '/?view=dodatki',         active: false },
                { label: 'Tutoriale',    href: '/?view=tutorials',       active: false },
                { label: 'Cennik',       href: '/?view=cennik',          active: false },
              ].map(item => (
